...
class lista_circular():
    ...
    def insertarsemestre(self,value,value2):
        ...
        while (True):
            if (aux.nombre == value):
                aux.listasemestre.insert_at_start(value2)
                encontrado = True
                break
            aux = aux.siguiente
            if (aux == self.primero):
...
class avl:
    ...
    def _imprimirarbol(self,value,value2,value3,cur_node):
        if value == cur_node.value:
            ...
            return self.imprimirarbol(value,value2,value3,cur_node.left_child)
        elif value>cur_node.value and cur_node.right_child!=None:
            return self.imprimirarbol(value,value2,value3,cur_node.right_child)
        return False
    ...
    def _insertararbol(self,value,value2,value3,_codigo,_nombre,_creditos,_preRequisitos,_esObligatorio,cur_node):
        if value == cur_node.value:
            ...
            return self.insertararbol(value,value2,value3,_codigo,_nombre,_creditos,_preRequisitos,_esObligatorio,cur_node.left_child)
        elif value>cur_node.value and cur_node.right_child!=None:
            return self.insertararbol(value,value2,value3,_codigo,_nombre,_creditos,_preRequisitos,_esObligatorio,cur_node.right_child)
        return False
    ...
    def _insertarsemestre(self,value,value2,value3,cur_node):
        if value == cur_node.value:
            ...
            return self.insertarsemestre(value,value2,value3,cur_node.left_child)
        elif value>cur_node.value and cur_node.right_child!=None:
            return self.insertarsemestre(value,value2,value3,cur_node.right_child)
        return False
...
if __name__=='__main__':
    ...
    hola.insert("20","kjds","jdsjkds","jkdskds","jdsjds","jsdkjds","dsds","jkdskjds")
    hola.insertarsemestre("20","2018","semestre1")
    me=""
