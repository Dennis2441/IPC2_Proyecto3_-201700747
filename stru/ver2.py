...
class arbolB:
    ...
    def graficaB2(self, raiz):
        ...
        s.view()
        os.system("dot -Tsvg arbolB -o "r"C:\Users\denni\OneDrive\Desktop\arbolcurso.svg")
...
class semestre:
    ...
    def insertararbol(self, value,_codigo, _nombre, _creditos, _preRequisitos, _esObligatorio):
        ...
        while (True):
            if (aux.nombre == value):
                encontrado = True
                aux.arbol.insertar(Curso(_codigo,_nombre,_creditos,_preRequisitos,_esObligatorio))
                break
            aux = aux.next
            if (aux == self.first):
                break
    ...
    def Agregarinicio(self, value):
        ...
        if self.first == None:
            self.first = Nodosemestre(value)
            self.first.next = self.first
        else:
            if(self.buscar(value)==True):
                hola="Ya existe"
            else:
                aux = self.first
                while aux.next is not self.first:
                    aux = aux.next
                aux.next = Nodosemestre(value)
                Curso.next = self.first  
...
class lista_circular():
    ...
    def insertararbol(self,value,value2,_codigo,_nombre,_creditos,_preRequisitos,_esObligatorio):
        ...
        while (True):
            if (aux.nombre == value):
                aux.listasemestre.insertararbol(value2,_codigo, _nombre, _creditos, _preRequisitos, _esObligatorio)
                encontrado = True
                break
            aux = aux.siguiente
            if (aux == self.primero):
    ...
    def insertarsemestre(self,value,value2):
        ...
        while (True):
            if (aux.nombre == value):
                aux.listasemestre.Agregarinicio(value2)
                encontrado = True
                break
            aux = aux.siguiente
            if (aux == self.primero):
    ...
    def imprimirarbol(self,value,value2):
        ...
        while (True):
            if (aux.nombre == value):
                aux.listasemestre.imprimirarbol(value2)
                encontrado = True
                break
            aux = aux.siguiente
            if (aux == self.primero):
...
class avl:
    ...
    def _search4(self, value,value2, cur_node):
        if value == cur_node.value:
            ...
            return self._search4(value,value2,cur_node.left_child)
        elif value>cur_node.value and cur_node.right_child!=None:
            return self._search4(value,value2,cur_node.right_child)
        return False
    ...
    def _search3(self, value,value2, cur_node):
        if value == cur_node.value:
            ...
            return self._search3(value,value2,cur_node.left_child)
        elif value>cur_node.value and cur_node.right_child!=None:
            return self._search3(value,value2,cur_node.right_child)
        return False
    ...
    def imprimirarbol(self,value,value2,value3):
        ...
        if self.root == None:
            print("No hay Datos")
             ...
             return self._imprimirarbol(value,value2,value3,self.root)

    def _imprimirarbol(self,value,value2,value3,cur_node):
        if value == cur_node.value:
            if(cur_node.listaayear.buscar(value2)==True):
                hola=""
                cur_node.listaayear.imprimirarbol(value2,value3)
            return True
        elif value<cur_node.value and cur_node.left_child!=None:
            return self._imprimirarbol(value,value2,value3,cur_node.left_child)
        elif value>cur_node.value and cur_node.right_child!=None:
            return self._imprimirarbol(value,value2,value3,cur_node.right_child)
        return False
    def insertararbol(self,value,value2,value3,_codigo,_nombre,_creditos,_preRequisitos,_esObligatorio):
        ...
        if self.root == None:
            print("No hay Datos")
             ...
             return self._insertararbol(value,value2,value3,_codigo,_nombre,_creditos,_preRequisitos,_esObligatorio,self.root)

    
    def _insertararbol(self,value,value2,value3,_codigo,_nombre,_creditos,_preRequisitos,_esObligatorio,cur_node):
        if value == cur_node.value:
            if(cur_node.listaayear.buscar(value2)==True):
                cur_node.listaayear.insertararbol(value2,value3,_codigo,_nombre,_creditos,_preRequisitos,_esObligatorio)
            
            return True
        elif value<cur_node.value and cur_node.left_child!=None:
            return self._insertararbol(value,value2,value3,_codigo,_nombre,_creditos,_preRequisitos,_esObligatorio,cur_node.left_child)
        elif value>cur_node.value and cur_node.right_child!=None:
            return self._insertararbol(value,value2,value3,_codigo,_nombre,_creditos,_preRequisitos,_esObligatorio,cur_node.right_child)
        return False
    ...
    def insertarsemestre(self, value,value2,value3):
        if self.root == None:
            print("No hay Datos")
             ...
             return self._insertarsemestre(value,value2,value3,self.root)
    def _insertarsemestre(self,value,value2,value3,cur_node):
        if value == cur_node.value:
            if(cur_node.listaayear.buscar(value2)==True):
                hola=""
                cur_node.listaayear.insertarsemestre(value2,value3)
            
            return True
        elif value<cur_node.value and cur_node.left_child!=None:
            return self._insertarsemestre(value,value2,value3,cur_node.left_child)
        elif value>cur_node.value and cur_node.right_child!=None:
            return self._insertarsemestre(value,value2,value3,cur_node.right_child)
        return False
